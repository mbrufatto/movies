...
struct MovieDetailView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let movieDetail = MovieDetail(title: "Batman Begins", year: "1992", rated: "PG-13", plot: "After training with his mentor, Batman begins his fight to free crime-ridden Gotham City from corruption", director: "Christopher Nolan", actors: "", imdbRating: "7.8", poster: "https://m.media-amazon.com/images/M/MV5BOTY4YjI2N2MtYmFlMC00ZjcyLTg3YjEtMDQyM2ZjYzQ5YWFkXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg", imdbId: "345fgD")
        
        return MovieDetailView(movieDetailVM: MovieDetailViewModel(movieDetail: movieDetail)).embedNavigationView()
    }
}
